...
st.set_page_config(page_title = 'Simple ChatBot', page_icon = logo)

#st.title('Simple ChatBot using LangChain')
st.markdown("<h1 style='text-align:center; color:black;'>Simple ChatBot using LangChain</h1>", unsafe_allow_html = True)
